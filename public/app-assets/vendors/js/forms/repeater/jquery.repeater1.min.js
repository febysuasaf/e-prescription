    ...
    ! function (a) {
        ...
        return a(this).each(function () {
            var e = a(this),
                ...
                k = e.find("[data-repeater-list1]").first(),
                l = function (b, c) {
                ...
                p = function () {
                    return l(k.find("[data-repeater-item1]"), c.repeaters)
                },
                q = k.find("[data-repeater-item1]").first().clone().hide(),
                r = l(l(a(this).find("[data-repeater-item1]"), c.repeaters).first().find("[data-repeater-delete1]"), c.repeaters);
                    ...
                    b.each(function (b) {
                        ...
                        e.data("item-name", c + "[" + b + "]"), l(e.find("[name]"), d).each(function () {
                            ...
                            f.attr("name", j), u(d, e, function (d) {
                                var e = a(this);
                                v(l(e.find("[data-repeater-item1]"), d.repeaters || []), c + "[" + b + "][" + e.find("[data-repeater-list1]").first().data("repeater-list") + "]", d.repeaters)
                            })
                        })
            ...
            var w = function () {
                var d = function (e, f, h) {
                    ...
                    u(h, e, function (b) {
                        var c = a(this);
                        l(c.find("[data-repeater-item1]"), b.repeaters).each(function () {
                            var e = c.find("[data-repeater-list1]").data("repeater-list");
                            if (f && f[e]) {
                                var h = a(this).clone();
                                c.find("[data-repeater-item1]").remove(), g(f[e], function (a) {
                                    var e = h.clone();
                                    d(e, a, b.repeaters || []), c.find("[data-repeater-list1]").append(e)
                                })
            ...
            d = function (a) {
                p().remove(), g(a, x)
            }, l(e.find("[data-repeater-create1]"), c.repeaters).click(function () {
                x()
            }), k.on("click", "[data-repeater-delete1]", function () {
                var b = a(this).closest("[data-repeater-item1]").get(0);
                i.call(b, function () {
